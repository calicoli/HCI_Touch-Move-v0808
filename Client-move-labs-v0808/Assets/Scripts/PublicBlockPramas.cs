...
public class PublicBlockParams : MonoBehaviour
{
    ...
    public struct BlockCondition
    {
        string prefix;
        int blockid;
        PublicLabParams.Lab1_move_28.Posture posture;
        PublicLabParams.Lab1_move_28.Orientation orientation;
        PublicLabParams.Lab1_move_28.Shape shape;
        float angle;
        ...
        public BlockCondition(int bid, int p, int o, int a, int s)
        {
            ...
            posture = (PublicLabParams.Lab1_move_28.Posture)p;
            orientation = (PublicLabParams.Lab1_move_28.Orientation)o;
            shape = (PublicLabParams.Lab1_move_28.Shape)s;
            angle = PublicLabParams.Lab1_move_28.AngleOfScreens[(int)a];
        }
        ...
        public PublicLabParams.Lab1_move_28.Posture getPosture()
        {
            return posture;
        }

        public PublicLabParams.Lab1_move_28.Orientation getOrientation()
        {
            return orientation;
        }
        ...
        public PublicLabParams.Lab1_move_28.Shape getShape()
        {
            return shape;
        }
